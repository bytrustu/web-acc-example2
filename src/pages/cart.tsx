        ...
        <div className="flex">
            ...
            {cartItems.map((product) => (
              <div className="cart-container" key={product.id}>
                <div className="flex gap-15 mt-10">
                  <img className="w-144 h-144" src={product.imageUrl} alt={product.name} tabIndex={0} />
                  <span className="cart-name" tabIndex={0}>
                    {product.name}
                  </span>
                </div>
                <div className="flex-col-center justify-end gap-15">
                  <button
                    ...
                    aria-label="상품 삭제"
                  >
                    <img className="cart-trash-svg" src="./assets/icon2.svg" alt="삭제 아이콘" />
                  </button>
          ...
          <section className="cart-right-section">
            <div className="cart-right-section__top">
              <h3 className="cart-title" tabIndex={0}>
                결제예상금액
              </h3>
            </div>
            ...
            <div className="cart-right-section__bottom">
              <div className="flex justify-between p-20 mt-20">
                <span className="highlight-text" tabIndex={0}>
                  합계
                </span>
                <span className="highlight-text" tabIndex={0}>
